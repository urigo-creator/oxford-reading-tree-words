...
// "문장 고르기" 퀴즈용 예문. 카드에 나오는 단어/표현 하나하나마다, 그
// 단어가 실제로 쓰이는 한국어 문장과 그 단어가 들어간 올바른 영어 문장을
// 한 쌍으로 만들어뒀습니다. 키는 카드 word 의 소문자 텍스트입니다.
const SENTENCE_EXAMPLES = {
  'hide': { ko: '우리는 나무 뒤에 숨어요.', en: 'We hide behind a tree.' },
  'seek': { ko: '이번엔 네가 찾을 차례야.', en: "It's your turn to seek." },
  'see': { ko: '나는 새를 볼 수 있어요.', en: 'I can see a bird.' },
  'all': { ko: '나는 점심을 다 먹었어요.', en: 'I ate all my lunch.' },
  'yes': { ko: '응, 나는 아이스크림을 좋아해.', en: 'Yes, I like ice cream.' },
  'hide and seek': { ko: '우리 숨바꼭질 하자.', en: "Let's play hide and seek." },
  'can': { ko: '나는 높이 뛸 수 있어요.', en: 'I can jump high.' },
  "can't": { ko: '나는 신발을 못 찾겠어요.', en: "I can't find my shoes." },
  'look': { ko: '봐, 비가 온다!', en: "Look, it's raining!" },
  'bike': { ko: '내 자전거는 파란색이에요.', en: 'My bike is blue.' },
  'mum': { ko: '엄마가 나에게 이야기를 읽어줘요.', en: 'Mum reads me a story.' },
  'ride': { ko: '나는 자전거 타는 걸 좋아해요.', en: 'I like to ride my bike.' },
  'on': { ko: '나는 자전거를 타고 학교에 가요.', en: 'I go to school on my bike.' },
  'look at': { ko: '이것 좀 봐!', en: 'Look at this!' },
  'skip': { ko: '나는 공원에서 깡충깡충 뛰는 걸 좋아해요.', en: 'I like to skip in the park.' },
  'paint': { ko: '나는 그림을 그리고 싶어요.', en: 'I want to paint a picture.' },
  'sorry': { ko: '그건 미안해요.', en: 'I am sorry for that.' },
  'back': { ko: '강아지의 등을 쓰다듬어 주세요.', en: "Pat the dog's back." },
  'go away': { ko: '저리 가!', en: 'Go away!' },
  'come back': { ko: '이리 돌아와!', en: 'Come back here!' },
  'red': { ko: '나는 빨간 공이 있어요.', en: 'I have a red ball.' },
  'blue': { ko: '하늘이 파란색이에요.', en: 'The sky is blue.' },
  'muddy': { ko: '내 신발이 진흙투성이예요.', en: 'My shoes are muddy.' },
  'team': { ko: '우리는 같은 팀이에요.', en: 'We are on the same team.' },
  'in': { ko: '그녀는 빨간 셔츠를 입고 있어요.', en: 'She is in a red shirt.' },
  'come on': { ko: '자, 어서 가자!', en: "Come on, let's go!" },
  'big': { ko: '코끼리는 커요.', en: 'The elephant is big.' },
  'feet': { ko: '내 발이 차가워요.', en: 'My feet are cold.' },
  'monster': { ko: '괴물이 내 침대 밑에 있어요.', en: 'The monster is under my bed.' },
  'dinosaur': { ko: '나는 박물관에서 공룡을 봤어요.', en: 'I saw a dinosaur at the museum.' },
  'giant': { ko: '거인은 키가 아주 커요.', en: 'The giant is very tall.' },
  'dad': { ko: '아빠가 나랑 놀아줘요.', en: 'Dad plays with me.' },
  'diary': { ko: '나는 매일 밤 일기를 써요.', en: 'I write in my diary every night.' },
  'wet': { ko: '내 옷이 젖었어요.', en: 'My clothes are wet.' },
  'windy': { ko: '오늘은 바람이 많이 불어요.', en: 'It is very windy today.' },
  'sunny': { ko: '화창한 날이에요.', en: 'It is a sunny day.' },
  'hot': { ko: '수프가 뜨거워요.', en: 'The soup is hot.' },
  'fun': { ko: '우리는 정말 재미있었어요.', en: 'We had so much fun.' },
  'shop': { ko: '우리는 가게에 갔어요.', en: 'We went to the shop.' },
  'pool': { ko: '나는 수영장에서 수영해요.', en: 'I swim in the pool.' },
  'park': { ko: '우리는 공원에서 놀아요.', en: 'We play in the park.' },
  'day': { ko: '바쁜 하루였어요.', en: 'It was a busy day.' },
  'go': { ko: '나는 버스를 타고 학교에 가요.', en: 'I go to school by bus.' },
  'to': { ko: '우리는 공원으로 걸어갔어요.', en: 'We walked to the park.' },
  'dog': { ko: '내 강아지는 달리기를 좋아해요.', en: 'My dog likes to run.' },
  'play': { ko: '우리 같이 놀자.', en: "Let's play together." },
  'walk': { ko: '나는 매일 아침 강아지를 산책시켜요.', en: 'I walk my dog every morning.' },
  'sleep': { ko: '내 강아지는 하루 종일 자는 걸 좋아해요.', en: 'My dog likes to sleep all day.' },
  'run': { ko: '강아지는 달리는 걸 좋아해요.', en: 'The dog loves to run.' },
  'hate': { ko: '내 강아지는 목욕을 싫어해요.', en: 'My dog hates baths.' },
  'present': { ko: '나는 생일 선물을 받았어요.', en: 'I got a present for my birthday.' },
  'bunch': { ko: '그녀는 나에게 꽃다발을 줬어요.', en: 'She gave me a bunch of flowers.' },
  'flower': { ko: '나는 꽃을 꺾었어요.', en: 'I picked a flower.' },
  'chocolate': { ko: '나는 초콜릿을 좋아해요.', en: 'I love chocolate.' },
  'grape': { ko: '나는 포도를 먹었어요.', en: 'I ate a grape.' },
  'best': { ko: '이건 내가 제일 좋아하는 장난감이에요.', en: 'This is my best toy.' },
  'for': { ko: '이 선물은 너를 위한 거야.', en: 'This present is for you.' },
  'box': { ko: '선물이 상자 안에 있어요.', en: 'The present is in a box.' },
  'best of all': { ko: '무엇보다도 이게 최고야.', en: 'This is the best of all.' },
  'little': { ko: '작은 강아지가 귀여워요.', en: 'The little dog is cute.' },
  'top': { ko: '강아지가 시상대 맨 위에 서 있어요.', en: 'The dog stands on top of the podium.' },
  'net': { ko: '남자아이가 그물을 타고 올라가요.', en: 'The boy climbs the net.' },
  'slide': { ko: '나는 미끄럼틀을 타고 내려가요.', en: 'I go down the slide.' },
  'ladder': { ko: '사다리는 미끄럼틀 옆에 있어요.', en: 'The ladder is next to the slide.' },
  ...
  'again': { ko: '다시 한 번 하자!', en: "Let's do it again!" },
  'not': { ko: '나는 안 피곤해요.', en: 'I am not tired.' },
  'not again': { ko: '안돼, 또 이러지 마!', en: 'Not again!' },
  'cat': { ko: '고양이가 자고 있어요.', en: 'The cat is sleeping.' },
  'come': { ko: '이리 와줘.', en: 'Come here, please.' },
};
